...
RoomTableLo:
    .byte <JamesRoomBackground, <LivingRoomBackground, <background1, <background2
RoomTableHi:
    .byte >JamesRoomBackground, >LivingRoomBackground, >background1, >background2

AttributeTableLo:
    .byte <attribute1,  <LivingRoomAttributes, <attribute2
AttributeTableHi:
    .byte >attribute1, >LivingRoomAttributes, >attribute2
...
LoadZoneLo:
    .byte <JamesRoomLoadZones, <LivingRoomLoadZones, <Room1LoadZones, <Room2LoadZones
LoadZoneHi:
    .byte >JamesRoomLoadZones, >LivingRoomLoadZones,                                                                                                                                                                                                  >Room1LoadZones, >Room2LoadZones
...
;; load zones count, x pos, y pos, roomIndex, x pos...
...
LivingRoomLoadZones:
    ...
    .byte $30, $B8, $04 ; balcony
    .byte $30, $B0, $04

    .byte $78, $28, $06 ; outside 1
    .byte $70, $28, $06
Room1LoadZones:
...
JamesRoomBackground:    ; roomIndex: 0
    ...
    .byte $24,$24,$24,$24,$24,$24,$25,$24,$24,$24,$24,$24,$24,$24,$24,$24  
    .byte $24,$24,$24,$24,$24,$24,$24,$24,$24,$00,$24,$24,$24,$24,$24,$24
